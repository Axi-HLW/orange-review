module github.com/yzc/orange-review/app/review_server

go 1.22.9

replace github.com/yzc/orange-review/rpc_gen => ../../rpc_gen
...
require (
	...
	github.com/yzc/orange-review/rpc_gen v0.0.0-00010101000000-000000000000
